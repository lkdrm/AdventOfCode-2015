...
Given the four strings above, the total number of characters of string code:
(`2 + 5 + 10 + 6 = 23`) minus the total number of characters in memory for string values (`0 + 3 + 7 + 1 = 11`) is `23 - 11 = 12`.

# --- Part Two ---

Now, let's go the other way. 
In addition to finding the number of characters of code, you should now ***encode each code representation as a new string*** 
...
For the strings above, the total encoded length: 
(`6 + 9 + 16 + 11 = 42`) minus the characters in the original code representation (`23`, just like in the first part of this puzzle) is `42 - 23 = 19`.