...
public static class PrettyPrintExtensions
{
    ...
    /// <summary>
    /// Writes a formatted result for the specified day to the console output, including execution times.
    /// </summary>
    ...
    /// <param name="part1TimeSeconds">The execution time for part 1 in seconds.</param>
    /// <param name="part2TimeSeconds">The execution time for part 2 in seconds.</param>
    public static void PrintResult(string title, int dayNumber, string part1Answer, string part2Answer, double part1TimeSeconds, double part2TimeSeconds)
    {
        Console.WriteLine();
        ...
        Console.Write($" ({part1TimeSeconds:F3}s)");
        Console.ForegroundColor = ConsoleColor.Yellow;
        Console.Write(" | Part 2: ");
        Console.ForegroundColor = ConsoleColor.Green;
        Console.Write(part2Answer);
        Console.ForegroundColor = ConsoleColor.DarkGray;
        Console.WriteLine($" ({part2TimeSeconds:F3}s)");
        Console.ResetColor();
        Console.WriteLine();
    }
